...
INSERT INTO `patient` (`firstname`, `lastname`, `date_of_birth`, `gender`, `address`, `phone_number`) VALUES ('Test', 'TestBorderline', '1945-06-24', 'F', '2 High St','200-333-4444');
INSERT INTO `patient` (`firstname`, `lastname`, `date_of_birth`, `gender`, `address`, `phone_number`) VALUES ('Test', 'TestInDanger', '2004-06-18', 'F', '3 Club Road','300-444-5555');
